"""
Django settings for invesco_wealthvisio_45863 project.
...
ROOT_URLCONF = 'invesco_wealthvisio_45863.urls'
...
WSGI_APPLICATION = 'invesco_wealthvisio_45863.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "invesco_wealthvisio_45863 API",
    "DESCRIPTION": "API documentation for invesco_wealthvisio_45863 App",
    "VERSION": "v1",
}
